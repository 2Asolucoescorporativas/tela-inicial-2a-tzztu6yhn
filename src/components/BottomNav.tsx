...
export function BottomNav({ onNewInvoiceClick }: BottomNavProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-[#001f31]/95 backdrop-blur-md border-t border-white/10 px-4 py-2 flex items-center justify-around max-w-md mx-auto sm:max-w-xl md:max-w-2xl">
