  ...
  return (
    ...
    >
      <p className="text-sm text-white/60 text-center mb-6">
        Escolha o cliente destinatário da nota.
      </p>
      ...
      {loading ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center gap-4 py-10">
          ...
          <AppButton
            variant="primary"
            onClick={() => navigate('/cadastrar-cliente?returnTo=/emitir-leite/selecionar-cliente')}
          >
        ...
        <>
          ...
          <div className="mt-auto pt-6">
            <div className="app-button-group">
              ...
              <AppButton variant="primary" onClick={handleContinuar} disabled={!localSelectedId}>
                Continuar
              </AppButton>
            </div>
          </div>
